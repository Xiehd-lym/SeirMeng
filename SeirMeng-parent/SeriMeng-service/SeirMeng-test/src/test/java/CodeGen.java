...
public class CodeGen {
    ...
    public void genCode() {
        ...
        // D:\code\seir-meng\SeirMeng-parent\SeriMeng-service\SeirMeng-education
        // 通用的：获取项目路径，不写死
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/" +  "db_zx_guarantee" + "?serverTimezone=GMT%2B8");
        ...
        pc.setParent("com.haidong.SeirMeng.service");
        ...
        //设置BaseEntity
        strategy.setSuperEntityClass("com.haidong.SeirMeng.service.base.model.BaseEntity");
        // 填写BaseEntity中的公共字段
